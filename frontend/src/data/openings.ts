...
export const OPENINGS: OpeningLine[] = [
  ...
  },
  {
    ...
    commonVariations: [
      ...
      "KID structure",
      "KID transposition",
      "Modern to King's Indian",
      "Pirc to King's Indian",
      "Benoni-style King's Indian",
      "Old Indian to King's Indian",
    ],
    trainingLines: [
      {
      ...
      {
        name: "Delayed e4 KID Structure",
        moves: ["d4", "Nf6", "c4", "g6", "Nf3", "Bg7", "g3", "O-O", "Bg2", "d6", "O-O"],
        explanation: "A common transposition where White delays e4, but Black still reaches a King's Indian shell.",
        keyIdeas: ["Recognise the structure", "Castle before breaking", "Use e5 or c5 when ready"],
      },
      {
        name: "Modern Transposition to KID",
        moves: ["d4", "g6", "c4", "Bg7", "Nc3", "Nf6", "e4", "d6", "Nf3", "O-O"],
        explanation: "Black starts with a Modern move order but transposes into a King's Indian Defense setup.",
        keyIdeas: ["Do not rely on exact move order", "Build Nf6-g6-Bg7-d6", "Counterattack the center"],
      },
    ],
    appearsInTraining: true,
  },
