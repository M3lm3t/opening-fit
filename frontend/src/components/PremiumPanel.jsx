  ...
  return <section className="premiumUpgradeShell subscriptionPricing" id="premium-offer" aria-labelledby="pricing-title">
    ...
    <div className="subscriptionPlanGrid">
      ...
      <article className="subscriptionPlanCard subscriptionPlanCard--plus"><header><div><span>OpeningFit Plus</span><h2>{priceSummary}</h2></div>{interval === "annual" ? <strong>Best value</strong> : null}</header>
        ...
        <ul><li>Living three-role White and Black repertoire</li><li>Up to {analysisContract.plusWeeklyTasks} prioritised weekly tasks</li><li>Relevant source-game reviews when recoverable</li><li>Clearly labelled general setup drills when no game position is recoverable</li><li>Response plans saved with your account</li><li>Progress between genuinely comparable reports</li><li>Report and completed-training history</li><li>Full recommendation evidence where available</li></ul>
