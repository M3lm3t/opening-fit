  ...
  return <section className="premiumUpgradeShell subscriptionPricing" id="premium-offer" aria-labelledby="pricing-title">
    ...
    <div className="subscriptionPlanGrid">
      ...
      <article className="subscriptionPlanCard subscriptionPlanCard--plus"><header><div><span>OpeningFit Plus</span><h2>{priceSummary}</h2></div>{interval === "annual" ? <strong>Best value</strong> : null}</header>
        ...
        <ul><li>Living White and Black repertoire</li><li>Up to {analysisContract.plusWeeklyTasks} personalised weekly tasks</li><li>Own-game opening drills when a usable imported position is available</li><li>Clearly labelled general setup drills when no game position is recoverable</li><li>Progress between comparable reports</li><li>Evidence of whether trained weaknesses recur</li><li>Saved reports and full recommendation evidence where available</li></ul>
