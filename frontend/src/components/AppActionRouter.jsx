...
export default function AppActionRouter({ onViewChange }) {
  ...
  useEffect(() => {
    const routeMap = {
      ...
      "progress": { view: "progress", target: "openingfit-progress", path: "/progress" },
      "view progress": { view: "progress", target: "openingfit-progress", path: "/progress" },
      "check progress": { view: "progress", target: "openingfit-progress", path: "/progress" },
      "view saved progress": { view: "progress", target: "openingfit-progress", path: "/progress" },
