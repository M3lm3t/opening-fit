...
export default function AppActionRouter({ onViewChange }) {
  ...
  useEffect(() => {
    const routeMap = {
      ...
      "repertoire": { view: "report", target: "my-repertoire", path: "/report", reportView: "repertoire" },
      "my repertoire": { view: "report", target: "my-repertoire", path: "/report", reportView: "repertoire" },
      "view repertoire": { view: "report", target: "my-repertoire", path: "/report", reportView: "repertoire" },
      "view my repertoire": { view: "report", target: "my-repertoire", path: "/report", reportView: "repertoire" },
      ...
      "progress": { view: "account", target: "account-progress", path: "/account" },
      "view progress": { view: "account", target: "account-progress", path: "/account" },
      "check progress": { view: "account", target: "account-progress", path: "/account" },
      "view saved progress": { view: "account", target: "account-progress", path: "/account" },
      ...
      "premium": { view: "account", target: "account-membership", path: "/account" },
      "pricing": { view: "account", target: "account-membership", path: "/account" },
      "upgrade": { view: "account", target: "account-membership", path: "/account" },
      "upgrade to premium": { view: "account", target: "account-membership", path: "/account" },
      "get founder pass": { view: "account", target: "account-membership", path: "/account" },
