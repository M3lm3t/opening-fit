...
export default function CoachDashboard({
  ...
  return (
    <section className="coachDashboard" id="coach-dashboard" aria-label="OpeningFit Today">
      ...
      <TrainingStreakCard />
      <WeeklyRecap data={retentionData} fitData={fitData} reportHistory={reportHistory} active={Boolean(data)} weeklyGoal={weeklyGoal} onTraining={onTraining} onReport={onReport} />
