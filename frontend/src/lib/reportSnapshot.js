...
export function buildReportSnapshot({
  ...
  return {
    ...
    game_counts: gameCounts.contractVersion >= 2 ? {
      contractVersion: gameCounts.contractVersion,
      ...
      eligible: gameCounts.eligibleGames ?? gameCounts.eligible,
      gamesStructurallyUsable: gameCounts.structurallyUsableGames ?? gameCounts.analysedGames,
      gamesPgnAvailable: gameCounts.pgnAvailableGames ?? null,
      gamesParsed: gameCounts.parsedGames ?? gameCounts.analysedGames,
      gamesAttributed: gameCounts.attributedGames ?? null,
      gamesClassified: gameCounts.classifiedGames ?? gameCounts.classified,
      gamesUsedForOpeningStats: gameCounts.usedForOpeningStats ?? gameCounts.usableOpeningSignals,
      gamesUnclassified: gameCounts.unclassifiedGames ?? null,
      gamesExcluded: gameCounts.excludedGames,
